...
public class searchBook extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("<form method='post' action='searchBook' >");
		out.println("<h1>Search Book From My Book Tracker </h1>");
		out.println("<div class='form-group'>");
		out.println("<label for='KeyWord'> Title </label>");
		out.println("<input name='KeyWord' type='text' class='form-control'  placeholder='Enter Book Title To Search'>");
